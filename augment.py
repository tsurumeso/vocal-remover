...
from lib import dataset, spec_utils
...
if __name__ == "__main__":
    ...
    input_i = f"input_i_{args.pitch}.wav"
    input_v = f"input_v_{args.pitch}.wav"
    output_i = f"output_i_{args.pitch}.wav"
    output_v = f"output_v_{args.pitch}.wav"
    cmd_i = f"soundstretch {input_i} {output_i} -pitch={args.pitch}"
    cmd_v = f"soundstretch {input_v} {output_v} -pitch={args.pitch}"
    cache_suffix = f"_pitch{args.pitch}.npy"

    cache_dir = f"sr{args.sr}_hl{args.hop_length}_nf{args.n_fft}"
